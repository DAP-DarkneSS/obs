...
BuildConflicts: libqt4-devel
BuildConflicts: qwt6-devel
...
It also uses Phonon (Qt4 only) as a backend or something like aplay/mplayer.
...
%endif
        ...
        -DENABLE_GACTS=True \
%if %{use_qt5} || 0%{?suse_version} <= 1310
...
%dir %{_libdir}/leechcraft
%dir %{plugin_dir}
%{_libdir}/*-util-qt5.so.*
%{_libdir}/libleechcraft-xsd-qt5.so.*
%doc %{_mandir}/man1/leechcraft*.1.gz
...
%files blasq-rappor
%defattr(-,root,root)
%{plugin_dir}/*craft_blasq_rappor.so
%{translations_dir}/*craft_blasq_rappor*.qm

%files blasq-vangog
%defattr(-,root,root)
%{plugin_dir}/*craft_blasq_vangog.so
%{translations_dir}/*craft_blasq_vangog*.qm

%files blogique
%defattr(-,root,root)
%{plugin_dir}/*craft_blogique.so
...
%files devmon
%defattr(-,root,root)
%{plugin_dir}/*craft_devmon.so
%{translations_dir}/*craft_devmon_*.qm

%files dolozhee
%defattr(-,root,root)
%{plugin_dir}/*craft_dolozhee.so
...
%files historyholder
%defattr(-,root,root)
%{plugin_dir}/*craft_historyholder.so
%{translations_dir}/*craft_historyholder*.qm

%files hotsensors
%defattr(-,root,root)
%{plugin_dir}/*craft_hotsensors.so
%{qml_dir}/hotsensors
...
%{_datadir}/applications/leechcraft-lmp*-qt5.desktop
%dir %{qml_dir}/lmp
%{qml_dir}/lmp/*.qml
...
%defattr(-,root,root)
%{plugin_dir}/*craft_lmp_brainslugz.so
%dir %{qml_dir}/lmp
...
%files mellonetray
%defattr(-,root,root)
%{plugin_dir}/*craft_mellonetray.so
%{qml_dir}/mellonetray/
%{translations_dir}/*craft_mellonetray_*.qm

%files monocle
%defattr(-,root,root)
%{plugin_dir}/*craft_monocle.so
...
%files monocle-dik
%defattr(-,root,root)
%{plugin_dir}/*craft_monocle_dik.so
%{translations_dir}/*craft_monocle_dik_??.qm
%{translations_dir}/*craft_monocle_dik_??_??.qm

%files monocle-fxb
%defattr(-,root,root)
%{plugin_dir}/*craft_monocle_fxb.so
%{_datadir}/applications/leechcraft-monocle-fxb-qt5.desktop
...
%files monocle-pdf
%defattr(-,root,root)
%{plugin_dir}/*craft_monocle_pdf.so
%{_datadir}/applications/leechcraft-monocle-pdf-qt5.desktop
...
%defattr(-,root,root)
%{plugin_dir}/*craft_monocle_postrus.so
%{_datadir}/applications/leechcraft-monocle-postrus-qt5.desktop
%{translations_dir}/*craft_monocle_postrus_??.qm
%{translations_dir}/*craft_monocle_postrus_??_??.qm

%files monocle-seen
%defattr(-,root,root)
%{plugin_dir}/*craft_monocle_seen.so
%{_datadir}/applications/leechcraft-monocle-seen-qt5.desktop
%{translations_dir}/*craft_monocle_seen_??.qm
%{translations_dir}/*craft_monocle_seen_??_??.qm

%files musiczombie
%defattr(-,root,root)
%{plugin_dir}/*craft_musiczombie.so
...
%files scroblibre
%defattr(-,root,root)
%{plugin_dir}/*craft_scroblibre.so
...
%files textogroose
%defattr(-,root,root)
%{plugin_dir}/*craft_textogroose.so

%files touchstreams
%defattr(-,root,root)
%{plugin_dir}/*craft_touchstreams.so
