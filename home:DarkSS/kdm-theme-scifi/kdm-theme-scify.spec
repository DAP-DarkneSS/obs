...
%define _path scifikdm

Name:           kdm-theme-scify
Version:        7
Release:        0
Summary:        KDE login and display manager — theme

License:        Artistic 2.0
Url:            http://opendesktop.org/content/show.php?content=116183
Group:          System/GUI/KDE
Source0:        http://opendesktop.org/CONTENT/content-files/116183-scifikdm.tar.gz

# Provides:       kdm-branding = ?version
# Supplements:    packageand(kdm:branding-scifikdm)
...
%attr(644,root,root) %{_kde4_appsdir}/kdm/themes/%{_path}/scifi.xml
